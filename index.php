    ...
    <body id="page-top">
        ...
        <header class="py-5 bg-image-full" style="background-image: url('./image/1.jpg')">
            <div class="text-center my-5">
                ...
                <a href="menu.pdf" target="blank" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Lihat Menu</a>
                <a href="reservasi.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Reservasi Tempat BBQ</a>
